(function($) {
  ...
  $(function() {
    ...
    if ($("#north-america-chart-dark").length) {
      var areaData = {
        labels: ["Australia", "England", "United States"],
        datasets: [{
            data: [10, 30, 50],
            backgroundColor: [
              "#71c016", "#ffc100", "#248afd",
      ...
      var areaOptions = {
        ...
        legendCallback: function(chart) { 
          var text = [];
          text.push('<div class="report-chart">');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[0] + '"></div><p class="mb-0">Australia</p></div>');
            text.push('<p class="mb-0">883</p>');
            text.push('</div>');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[1] + '"></div><p class="mb-0">England</p></div>');
            text.push('<p class="mb-0">660</p>');
            text.push('</div>');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[2] + '"></div><p class="mb-0">United States</p></div>');
            text.push('<p class="mb-0">1760</p>');
            text.push('</div>');
          text.push('</div>');
          return text.join("");
        },
