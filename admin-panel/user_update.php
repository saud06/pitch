<?php
	...
	if(isset($_POST) && !empty($_POST)){
		...
		if(!$con->query($sql2)){
			...
			$_SESSION['message'] = 'You Have Successfully Updated User Information: <strong>' . $first_name . ' ' . $surname . '</strong>.';
