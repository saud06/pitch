		          	...
		          	<div class="card">
			            <div class="card-body">
			              	<h1 style="color: #ff5722" class="display-4">
			              		Video List &nbsp;
			              		<button type="button" class="btn btn-inverse-secondary btn-icon-text" title="Add Post Type" data-toggle="modal" data-target="#addTypeModal"><i class="ti-plus"></i>&nbsp; Add Type</button>
			              	</h1>
			                    ...
			                    <div class="modal-dialog" role="document">
			                      	<div class="modal-content">
				                        <div class="modal-header">
				                          	<h5 class="modal-title" id="addTypeModalLabel">Add Post Type</h5>
				                        ...
				                        <form class="cmxform" id="post_type_add_form" method="POST" action="post_type_add.php" enctype="multipart/form-data">
					                        <div class="modal-body" style="padding-bottom: 0">
							                    <fieldset>
							                      	<div class="row">
							                      		<div class="form-group col">
									                        <label for="type_name">Type Name</label>
									                        <input style="margin-bottom: 5px;" id="type_name" class="form-control" name="type_name" type="text" placeholder="Insert...">

									                        <span id="err_type_name"></span>
									                    </div>
									                </div>
													...
													<div class="row">
									                    <div class="form-group col">
								                        	...
								                        	<select style="margin-bottom: 5px;" class="form-control form-control-lg" name="type_status" id="type_status">
								                        		<option value="">Select...</option>
										                      	<option value="Active">Active</option>
										                      	<option value="Inactive">Inactive</option>
										                    </select>

										                    <span id="err_type_status"></span>
									                    </div>
							                      	</div>
							                    </fieldset>
					                        </div>
					                        ...
					                        <div class="modal-footer">
					                          	<button type="submit" id="post_type_add_btn" class="btn btn-inverse-success btn-fw"><i class="ti-upload btn-icon-prepend"></i> &nbsp; Submit</button>
...
<script type="text/javascript">
	...
	$("#post_type_add_btn").on('click', function(e){
        ...
        if(type_name == null || type_name == ""){
            $("#err_type_name").html('Please Insert Type Name.').css('color', 'red');
            return false;
        } else{
            $("#err_type_name").html('');
        }
        ...
        if (!type_name.match(name_regex)){
            $('#err_type_name').html('Please Insert a Valid Type Name.').css('color', 'red');
            return false;
        } else{
            $("#err_type_name").html('');
        }
        ...
        if (type_name.length < 3){
            $('#err_type_name').html('Type Name Must Contain At Least 3 Characters.').css('color', 'red');  
            return false;
        } else{
            $("#err_type_name").html('');
        }
        ...
        if(type_status == null || type_status == ""){
            $("#err_type_status").html('Please Select Status.').css('color', 'red');
            return false;
        } else{
            $("#err_type_status").html('');
        }

        $('#post_type_add_form').submit();
    });
